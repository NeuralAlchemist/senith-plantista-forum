...
public class CommentController{
    ...
    public ResponseEntity<Comment> getComment(@PathVariable Long id){
        Comment commentToGet = commentRepository.findById(id).orElseThrow(ResourceNotFoundException::new);
    ...
    public ResponseEntity<Comment> deleteComment(@PathVariable Long id){
        Comment commentToBeDeleted = commentRepository.findById(id).orElseThrow(ResourceNotFoundException::new);
